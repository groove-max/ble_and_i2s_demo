...
#define BLE_MAXIMUM_CHARS_IN_SERVICE  2                                       /**< The advertising interval (in units of 0.625 ms. This value corresponds to 187.5 ms). */

#define BMA280_INT2_PIN               NRF_GPIO_PIN_MAP(1, 13)                 /**< Define BMA280 INT2 pin. */
#define BMA280_SCL_PIN                NRF_GPIO_PIN_MAP(0, 27)                 /**< Define BMA280 TWI SCL pin. */
